...
class AllMoviesUseCase @Inject constructor(
    ...
    operator fun invoke(
        ...
        val getPopularityMovies = tmdbRepository.getDiscoverMovies(
            popularityMoviesPage,
            MovieType.POPULARITY_DESC.movieFilterDesc
        )
        val getRevenueMovies = tmdbRepository.getDiscoverMovies(
            revenueMoviesPage,
            MovieType.REVENUE_DESC.movieFilterDesc
        )
        val getPrimaryReleaseDateMovies = tmdbRepository.getDiscoverMovies(
            primaryReleaseDateMoviesPage,
            MovieType.PRIMARY_RELEASE_DATE_DESC.movieFilterDesc
        )
        val getVoteAverageMovies = tmdbRepository.getDiscoverMovies(
